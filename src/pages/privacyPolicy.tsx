...
const PrivacyPolicy = () => {
  ...
  <ul className="text-[11px] sm:text-xs font-medium mt-4 sm:mt-6 list-disc list-outside leading-6 sm:leading-7">
          ...
          <li> For more information about how targeted advertising works, you can visit the Network Advertising Initiative’s (“NAI”) educational page at <a className="underline" href="https://www.networkadvertising.org/understanding-online-advertising/how-does-it-work" target="_blank" rel="noopener noreferrer">https://www.networkadvertising.org/understanding-online-advertising/how-does-it-work</a>.</li>

          <li className="font-semibold"> You can opt out of targeted advertising by:</li>

          <li> <span className="font-semibold">FACEBOOK</span> - <a className="underline" href="https://www.facebook.com/settings/?tab=ads" target="_blank" rel="noopener noreferrer">https://www.facebook.com/settings/?tab=ads</a></li>

          <li> GOOGLE - <a className="underline" href="https://adssettings.google.com/authenticated" target="_blank" rel="noopener noreferrer">https://adssettings.google.com/authenticated</a></li>

          <li> BING - <a className="underline" href="https://advertise.bingads.microsoft.com/en-us/resources/policies/personalized-ads" target="_blank" rel="noopener noreferrer">https://advertise.bingads.microsoft.com/en-us/resources/policies/personalized-ads</a></li>

          <li> Additionally, you can opt out of some of these services by visiting the Digital Advertising Alliance’s opt-out portal at: <a className="underline" href="https://optout.aboutads.info/.." target="_blank" rel="noopener noreferrer">https://optout.aboutads.info/..</a></li>
          ...
          <li>Our Site sells Personal Information, as defined by the California Consumer Privacy Act of 2018 (“CCPA”).</li>
          <li>{'['}Insert:</li>
          <li className="italic">categories of information sold;</li>
          ...
          <li>Your Personal Information will be initially processed in Ireland and then will be transferred outside of Europe for storage and further processing, including to Canada and the United States. For more information on how data transfers comply with the GDPR, see Shopify’s GDPR Whitepaper: <a className="underline" href="https://help.shopify.com/en/manual/your-account/privacy/GDPR" target="_blank" rel="noopener noreferrer">https://help.shopify.com/en/manual/your-account/privacy/GDPR</a>. </li>

          <li>CCPA</li>
          <li>If you are a resident of California, you have the right to access the Personal Information we hold about you, to port it to a new service, and to ask that your Personal Information be corrected, updated, or erased. If you would like to exercise these rights, please contact us through the contact information above. </li>

          <li>Additionally, if you are a resident of California, you have the right to opt out of the sale of your Personal Information. To exercise this right, please contact us through the contact information above.</li>
          <li>Cookies</li>
          ...
          <li className="italic">[Be sure to check this list against Shopify’s current list of cookies on the merchant storefront: <a className="underline" href="https://help.shopify.com/en/manual/your-account/privacy/cookies" target="_blank" rel="noopener noreferrer">https://help.shopify.com/en/manual/your-account/privacy/cookies</a> {']'}</li>

          <li>Cookies Necessary for the Functioning of the Store</li>
          <li>we change cookies partner often,please contact us about our latest partners</li>
          <li>The length of time that a cookie remains on your computer or mobile device depends on whether it is a “persistent” or “session” cookie. Session cookies last until you stop browsing and persistent cookies last until they expire or are deleted. Most of the cookies we use are persistent and will expire between 30 minutes and two years from the date they are downloaded to your device.</li>
          <li>You can control and manage cookies in various ways. Please keep in mind that removing or blocking cookies can negatively impact your user experience and parts of our website may no longer be fully accessible.</li>
          <li>Most browsers automatically accept cookies, but you can choose whether or not to accept cookies through your browser controls, often found in your browser’s “Tools” or “Preferences” menu. For more information on how to modify your browser settings or how to block, manage or filter cookies can be found in your browser’s help file or through such sites as: <a className="underline" href="https://www.aboutcookies.org" target="_blank" rel="noopener noreferrer">https://www.aboutcookies.org</a>.</li>

          <li>Additionally, please note that blocking cookies may not completely prevent how we share information with third parties such as our advertising partners. To exercise your rights or opt-out of certain uses of your information by these parties, please follow the instructions in the “Behavioural Advertising” section above.</li>
        ...
        <ul className="text-[11px] sm:text-xs font-medium mt-4 sm:mt-6 list-disc list-outside leading-6 sm:leading-7 mb-8 sm:mb-10">
          ...
          <li className="font-semibold">Last updated: 22.05.2026</li>
